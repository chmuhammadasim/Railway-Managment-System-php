...
.emp-sidebar {
    ...
    background:linear-gradient(180deg,#134e4a,#0d3330);
    color:#a7f3d0; display:flex; flex-direction:column;
    position:sticky; top:64px; height:calc(100vh - 64px); overflow-y:auto;
    padding-top:.5rem;
}
.emp-sidebar .sb-brand { padding:1.1rem 1.5rem .85rem; border-bottom:1px solid rgba(255,255,255,.08); font-weight:700; color:#6ee7b7; font-size:.95rem; }
.emp-sidebar a {
    display:flex; align-items:center; gap:.7rem;
    padding:.6rem 1.5rem; color:#a7f3d0; text-decoration:none;
    font-size:.86rem; font-weight:500; transition:all .2s;
    border-left:3px solid transparent;
}
.emp-sidebar a:hover, .emp-sidebar a.active {
    background:rgba(255,255,255,.08); color:#fff; border-left-color:#34d399;
}
.emp-sidebar a i { font-size:.95rem; width:1rem; text-align:center; }
.emp-sidebar .sb-sep { padding:.5rem 1.5rem .25rem; font-size:.68rem; text-transform:uppercase; letter-spacing:1.5px; opacity:.4; margin-top:.5rem; color:#6ee7b7; }
